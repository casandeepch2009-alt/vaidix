// ════════════════════════════════════════════════════════════════════════════
// /faculty/decks/new — Deck-forge wizard (Phase 1B)
// ════════════════════════════════════════════════════════════════════════════
...
//
// The legacy "Forge presentation" button on /faculty/documents/[id] still
...
export default async function DeckWizardPage() {
  ...
  if (!session?.user) redirect('/login?next=/faculty/decks/new');
