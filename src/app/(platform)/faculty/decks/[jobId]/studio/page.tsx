// ════════════════════════════════════════════════════════════════════════════
// /faculty/decks/[jobId]/studio — Presentation Studio (Phase 1C)
// ════════════════════════════════════════════════════════════════════════════
...
//
// The legacy editor at /faculty/decks/[jobId] is kept for backward compat
...
export default async function PresentationStudioPage({
  ...
  if (!session?.user) redirect(`/login?next=/faculty/decks/${jobId}/studio`);
